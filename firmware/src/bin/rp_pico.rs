...
fn rp2040_main() -> ! {
  ...
  *USB_BUS = Some(UsbBusAllocator::new(hal::usb::UsbBus::new(
  ...
  let mut ind1_pin = pins.gpio10.into_push_pull_output();
  let mut ind2_pin = pins.gpio11.into_push_pull_output();
  ind1_pin.set_high().unwrap();
  ind2_pin.set_high().unwrap();
  ...
  let mut led_clk2_pin = pins.gpio9.into_push_pull_output();
  let mut led_clk3_pin = pins.gpio13.into_push_pull_output();
  let mut led_clk4_pin = pins.gpio20.into_push_pull_output();
  let mut led_clk5_pin = pins.gpio18.into_push_pull_output();
  let mut led_clk6_pin = pins.gpio16.into_push_pull_output();
  let mut led_clk7_pin = pins.gpio15.into_push_pull_output();
  let mut switch1_en_pin = pins.gpio6.into_push_pull_output();
  let mut switch2_en_pin = pins.gpio8.into_push_pull_output();
  let mut switch3_en_pin = pins.gpio12.into_push_pull_output();
  let mut switch4_en_pin = pins.gpio21.into_push_pull_output();
  let mut switch5_en_pin = pins.gpio19.into_push_pull_output();
  let mut switch6_en_pin = pins.gpio17.into_push_pull_output();
  let mut switch7_en_pin = pins.gpio14.into_push_pull_output();
  led_rst_pin.set_high().unwrap();
  switch1_en_pin.set_high().unwrap();
  switch2_en_pin.set_high().unwrap();
  switch3_en_pin.set_high().unwrap();
  switch4_en_pin.set_high().unwrap();
  switch5_en_pin.set_high().unwrap();
  switch6_en_pin.set_high().unwrap();
  switch7_en_pin.set_high().unwrap();
  delay.delay_us(1);
  ...
  loop {
    ...
    bus5_pin.set_state(values[4].into()).unwrap();
    bus6_pin.set_state(values[5].into()).unwrap();
    led_clk2_pin.set_high().unwrap();
    delay.delay_us(1);
    led_clk2_pin.set_low().unwrap();
    delay.delay_us(1);
    ...
    bus5_pin.set_state(values[4].into()).unwrap();
    bus6_pin.set_state(values[5].into()).unwrap();
    led_clk3_pin.set_high().unwrap();
    delay.delay_us(1);
    led_clk3_pin.set_low().unwrap();
    delay.delay_us(1);
    ...
    bus5_pin.set_state(values[4].into()).unwrap();
    bus6_pin.set_state(values[5].into()).unwrap();
    led_clk4_pin.set_high().unwrap();
    delay.delay_us(1);
    led_clk4_pin.set_low().unwrap();
    delay.delay_us(1);
    ...
    bus5_pin.set_state(values[4].into()).unwrap();
    bus6_pin.set_state(values[5].into()).unwrap();
    led_clk5_pin.set_high().unwrap();
    delay.delay_us(1);
    led_clk5_pin.set_low().unwrap();
    delay.delay_us(1);
    ...
    bus5_pin.set_state(values[4].into()).unwrap();
    bus6_pin.set_state(values[5].into()).unwrap();
    led_clk6_pin.set_high().unwrap();
    delay.delay_us(1);
    led_clk6_pin.set_low().unwrap();
    delay.delay_us(1);
    ...
    bus5_pin.set_state(values[4].into()).unwrap();
    bus6_pin.set_state(values[5].into()).unwrap();
    led_clk7_pin.set_high().unwrap();
    delay.delay_us(1);
    led_clk7_pin.set_low().unwrap();
    delay.delay_us(1);
